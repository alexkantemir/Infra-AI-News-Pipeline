...
py -3.13 publish.py --url "https://example.com/article" --schedule 2026-06-03T12:00:00Z
...
py -3.13 publish.py --json post/2026-06-03-article.json --image post/2026-06-03-article.png

# Пересоздать картинку, но использовать готовый JSON
py -3.13 publish.py --json post/2026-06-03-article.json
```
...
```bash
# Только Telegram
py -3.13 tg_post.py --json post/article.json --image post/article.png
py -3.13 tg_post.py --content "Текст поста"

# Только VK
py -3.13 vk_post.py --json post/article.json
py -3.13 vk_post.py --content "Текст поста" --schedule 2026-06-03T12:00:00Z

# Только картинка
py -3.13 generate_image_from_json.py --json post/article.json --output post/article.png
```
...
```bash
py -3.13 publish.py --json post/file.json --image post/file.png
```
